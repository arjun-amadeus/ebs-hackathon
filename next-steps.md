...
- Azure Container App to host the 'galata-extension' service.
- Azure Container App to host the 'staging' service.
- Azure Container App to host the 'static' service.
- Azure Container App to host the 'extension' service.
- Azure Container App to host the 'incompat' service.
- Azure Container App to host the 'consumer' service.
- Azure Container App to host the 'provider' service.
- Azure Container App to host the 'token' service.
- Azure Container App to host the 'mimeextension' service.
- Azure Container App to host the 'package' service.
- Azure Container App to host the 'test-hyphens' service.
- Azure Container App to host the 'test-hyphens-underscore' service.
- Azure Container App to host the 'test-no-hyphens' service.
- Azure Container App to host the 'executable' service.
- Azure Container App to host the 'static' service.
- Azure Container App to host the 'lab-extension' service.
- Azure Container App to host the 'jupyterlab-manager' service.
- Azure Container App to host the 'jupyterlab-pygments' service.
